...
import json
# 项目名称
projectName = '/gulp-freemarker-release'
# 临时目录
feRelease = '../fe-release/'
# 部署上线gitlab地址
feReleaseGit = 'https://github.com/xmllein/gulp-freemarker-release.git'
...
# 上线测试环境
def releaseOnline():
    print 'release to gulp-freemarker-release start...'
    # 打包存放临时目录
    bakTmp = './dist'
    ...
    print 'release to gulp-freemarker-release end'
